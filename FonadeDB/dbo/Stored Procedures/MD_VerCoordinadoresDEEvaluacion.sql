...
CREATE PROCEDURE [dbo].[MD_VerCoordinadoresDEEvaluacion]
...
SELECT
	...
	INNER JOIN grupocontacto gc ON id_contacto=gc.codcontacto and codgrupo = (select Id_Grupo from Grupo where Id_Grupo=10)
