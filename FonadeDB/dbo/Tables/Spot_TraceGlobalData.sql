CREATE TABLE [dbo].[Spot_TraceGlobalData] (
...
CREATE UNIQUE CLUSTERED INDEX [CL_UQ_id_Idx]
    ON [dbo].[Spot_TraceGlobalData]([id] ASC) WITH (FILLFACTOR = 50);


GO
CREATE NONCLUSTERED INDEX [EventClass_Idx]
    ON [dbo].[Spot_TraceGlobalData]([EventClass] ASC) WITH (FILLFACTOR = 50);


GO
CREATE NONCLUSTERED INDEX [TracedSpid_EventClass_StartTime]
    ON [dbo].[Spot_TraceGlobalData]([TracedSpid] ASC, [EventClass] ASC, [StartTime] ASC) WITH (FILLFACTOR = 50);
