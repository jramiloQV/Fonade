CREATE TABLE [dbo].[Spot_TraceData] (
    [TracingSpid]     INT             CONSTRAINT [DF_Spot_TraceData_spid] DEFAULT (@@spid) NULL,
...
CREATE CLUSTERED INDEX [SPID_Idx]
    ON [dbo].[Spot_TraceData]([TracingSpid] ASC) WITH (FILLFACTOR = 50);
