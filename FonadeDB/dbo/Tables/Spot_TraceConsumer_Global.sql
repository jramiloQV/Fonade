CREATE TABLE [dbo].[Spot_TraceConsumer_Global] (
...
CREATE UNIQUE NONCLUSTERED INDEX [ConsumerGlobal_id]
    ON [dbo].[Spot_TraceConsumer_Global]([id] ASC) WITH (FILLFACTOR = 50);


GO
CREATE CLUSTERED INDEX [ConsumerGlobal_SPIDEvntCls]
    ON [dbo].[Spot_TraceConsumer_Global]([SPID] ASC, [EventClass] ASC) WITH (FILLFACTOR = 50);
