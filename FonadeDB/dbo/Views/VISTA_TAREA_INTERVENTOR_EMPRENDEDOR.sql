CREATE VIEW dbo.[VISTA_TAREA_INTERVENTOR_EMPRENDEDOR]
AS
...
WHERE     (tu.CodContactoAgendo IN
                          (SELECT     CodContacto
                            ...
                            WHERE      (CodGrupo = 14))) AND (tu.CodContacto IN
                          (SELECT     CodContacto
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 9
         ...
         Width = 1500
         Width = 1500
         Width ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VISTA_TAREA_INTERVENTOR_EMPRENDEDOR';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'= 1500
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VISTA_TAREA_INTERVENTOR_EMPRENDEDOR';




GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VISTA_TAREA_INTERVENTOR_EMPRENDEDOR';
