CREATE VIEW dbo.VW_TodosLosProyectosTodoTitulo50000
AS
SELECT     TOP (50000) PC.CodProyecto, dbo.Proyecto.NomProyecto, C.Nombres, C.Apellidos, C.Identificacion, CE.TituloObtenido, CE.AnoTitulo, CE.Institucion, 
...
WHERE     (PC.CodRol = 3) AND (PC.CodProyecto >= 24586)
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "ProgramaAcademico"
            ...
            End
            DisplayFlags = 280
    ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_TodosLosProyectosTodoTitulo50000';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'VW_TodosLosProyectosTodoTitulo50000';
