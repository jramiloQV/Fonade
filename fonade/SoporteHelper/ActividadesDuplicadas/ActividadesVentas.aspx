<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ActividadesVentas.aspx.cs" Inherits="Fonade.SoporteHelper.ActividadesDuplicadas.ActividadesVentas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlace" runat="server">
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Buscar actividades de ventas por codigo de proyecto"></asp:Label>          
    <br />
    ...
    <asp:GridView ID="gvActividad" runat="server" AllowPaging="false"   AutoGenerateColumns="False" DataSourceID="dataActividades" EmptyDataText="No hay actividades." Width="98%" BorderWidth="0" CellSpacing="1" CellPadding="4" CssClass="Grilla" HeaderStyle-HorizontalAlign="Left"  OnRowCommand="gvActividad_RowCommand">
        ...
        <asp:ObjectDataSource
                ID="dataActividades"
                runat="server"
                TypeName="Fonade.SoporteHelper.ActividadesDuplicadas.ActividadesVentas"
