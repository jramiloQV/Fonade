...
namespace Fonade.Controles
{
    ...
    public partial class CatalogoGastoV2 : System.Web.UI.UserControl
    {
        /// <summary>
        /// Accion
        /// </summary>
        ...
        protected void btnGasto_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("~/PlanDeNegocioV2/Formulacion/Finanzas/CostosAdministrativos.aspx?codproyecto="+ hddCodProyecto.Value);
