<%@ Page Title="FONDO EMPRENDER" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true"
    CodeBehind="ActualizarInformacionAdicionalMiperfil.aspx.cs" Inherits="Fonade.FONADE.Administracion.ActualizarInformacionAdicionalMiperfil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlace" runat="server">
    <%--Información General--%>
    <h1>
        <asp:Label ID="lbl_enunciado" runat="server" Text="ACTIVAR ACTUALIZACIÓN DE INFORMACIÓN ADICIONAL" />
    </h1>
                    ...
                    <td align="center" valign="top" width="98%">
                        <table width="95%" border="0" align="center" cellspacing="0" cellpadding="3">
                            <tbody>
                                ...
                                <tr valign="top">
                                    <td class="TitDestacado" align="left">
                                        <asp:CheckBox ID="chk_actualizarInfo" Text="Actualizar información adicional en mi perfil:"
