<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ExportarInformacionIA.aspx.cs" Inherits="Fonade.FONADE.Administracion.ExportarInformacionIA" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function alerta() {
            var slt = document.getElementById('bodyContentPlace_ddlconvocatoria');
            var valor = slt.options[slt.selectedIndex].text;

            if (valor != "Seleccione") {
                return confirm('¿Está seguro de exportar la informacion de la convocatoria ' + valor + '?, este proceso puede tardar varios minutos, por favor no cierre la ventana.');
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlace" runat="server">
    ...
    <h1>
        <label>
            Exportación información para IA</label>
    </h1>
    <div>
        <div>
    ...
    <asp:Button ID="btnMostrarConfirmacion" runat="server" Text="Exportar Informacion para IA"
