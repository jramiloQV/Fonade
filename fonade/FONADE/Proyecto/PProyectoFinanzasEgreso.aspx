                        ...
                        <tr>
                            <td align='left' valign='top' width='98%'>
                                <table width='100%' border='0' cellspacing='1' cellpadding='4'>
                                    <tr>
                                        <td align='left'>
                                            <asp:Panel ID="pnlAdicionar" runat="server" Visible="true">
                                ...
                                <asp:GridView ID="gw_InversionesFijas" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Concepto" HeaderStyle-Width="47%" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkConcepto" runat="server" CommandArgument='<%# Eval("Id_Inversion") %>' CommandName="Editar" Text='<%# Eval("concepto") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
