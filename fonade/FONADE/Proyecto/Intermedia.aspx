<%@ Page Title="" Language="C#" MasterPageFile="~/Emergente.Master" AutoEventWireup="true" CodeBehind="Intermedia.aspx.cs" Inherits="Fonade.FONADE.Proyecto.Intermedia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlace" runat="server">
    ...
    <br />
    <br />
    <%--<asp:LinqDataSource ID="ldsTipoInsumo" runat="server" ContextTypeName="Datos.FonadeDBDataContext" OnSelecting="ldsTipoInsumo_Selecting">--%>
    <%--</asp:LinqDataSource>--%>
