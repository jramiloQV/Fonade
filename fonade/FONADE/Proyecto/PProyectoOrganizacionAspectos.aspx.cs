...
namespace Fonade.FONADE.Proyecto
{
    public partial class PProyectoOrganizacionAspectos : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.div_Post_It_2.Visible = true; tabla_docs.Visible = true;
        ...
        {
            txt_constitucion.Enabled = !(usuario.CodGrupo == Constantes.CONST_JefeUnidad);
            //if (pol != null)
            //{
            procesarCampo(ref txt_constitucion, ref panel_constitucion, pol != null ? pol.AspectosLegales : "", esMiembro, bRealizado, "");
            //}
            //else
            //{
        ...
        {
            Session["TabInvoca"] = "OrganizaAspecto";
