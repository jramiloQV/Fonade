<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PProyectoFinanzasIngreso.aspx.cs"
    Inherits="Fonade.FONADE.Proyecto.PProyectoFinanzasIngreso" ValidateRequest="false" %>
...
<body>
    ...
    <asp:Panel ID="pnlPrincipal" Visible="true" runat="server">
        ...
        <table id="tabla_docs" runat="server" visible="false" width="780" border="0" cellspacing="0"
            ...
            <tr>
                <td align="right">
                    <table runat="server" width="52" border="0" cellspacing="0" cellpadding="0">
                        <tr align="center">
                            <td style="width: 50px;">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <div id="div_post_it_2" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="FormatosFinancieros" _txtTab="1" Visible="false" 
                                        _mostrarPost="false"/>
                                    <%--Visible='<%# ((bool)DataBinder.GetPropertyValue(this, "ejecucion")) %>'--%> 
                                </div>
                            </td>
            ...
            <tr>
                <td>
                    <asp:Button ID="btnLinkBajarModeloFinanciero" runat="server" Text="Bajar Modelo Financiero"
                        OnClick="btnLinkBajarModeloFinanciero_Click" CssClass="boton_Link" 
                        Visible='<%# Convert.ToBoolean(DataBinder.GetPropertyValue(this, "vislzItem")??false) %>' />
                </td>
                <td>
                    <asp:Button ID="btnLinkSubirModeloFinanciero" runat="server" Text="Subir Modelo Financiero"
                        OnClick="btnLinkSubirModeloFinanciero_Click" CssClass="boton_Link"
                        Visible='<%# Convert.ToBoolean(DataBinder.GetPropertyValue(this, "vislzItem")??false) %>' />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Button ID="btnLinkGuiaLlenarModeloFinanciero" runat="server" Text="Guía para llenar Modelo Financiero"
                        OnClick="btnLinkGuiaLlenarModeloFinanciero_Click" CssClass="boton_Link"
                        Visible='<%# Convert.ToBoolean(DataBinder.GetPropertyValue(this, "vislzItem")??false) %>' />
                </td>
            </tr>
        </table>
