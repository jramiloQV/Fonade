...
<%--    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    ...
    <div>
        ...
        <table id="tabla_docs" runat="server" visible="false" width="780" border="0" cellspacing="0"
            ...
            <tr>
                <td>
                    <table runat = "server" width="52px;" border="0" cellspacing="0" cellpadding="0" align="right">
                        <tr align="center">
                            <td style="width: 50px;">
            ...
            <tr>
                ...
                <td>
                    <div id="div_Post_It_2" runat="server" visible="false">
                        <uc1:Post_It ID="Post_It2" runat="server" _txtCampo="AspectosLegales" _txtTab="1" _mostrarPost="false"/>
                    </div>
                </td>
            </tr>
        </table>
         <CKEditor:CKEditorControl ID="txt_constitucion" runat="server" EnableTabKeyTools="true" ForcePasteAsPlainText="false" BasePath="~/ckeditor"></CKEditor:CKEditorControl>
