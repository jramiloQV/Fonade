...
<body class="blanco">
	<form id="form1" runat="server">
		<div class="blanco">
			<table class="auto-style1 blanco">
				<tr>
					<td colspan="2">
						<!-- class="auto-style2"-->
				...
				<tr id="tr_mes" runat="server">
					...
					<td>
						<asp:TextBox ID="txt_mes" runat="server" ValidationGroup="accionar" Width="250px" Enabled="false"></asp:TextBox>
					</td>
				</tr>
				<tr id="tr_cargo" runat="server">
					...
					<td>
						<asp:TextBox ID="txt_cargo" runat="server" ValidationGroup="accionar" Width="250px" Enabled="false"></asp:TextBox>
					</td>
				</tr>
				<tr>
					<td style="text-align: center">
				...
				<tr>
					<td style="text-align: center;" colspan="2">
						<asp:ImageButton ID="img_btn_NuevoDocumento" ImageUrl="../../Images/icoClip.gif"
							runat="server" ToolTip="Nuevo Documento"
							CommandName="NuevoDocumento" Visible="true" OnClick="img_btn_NuevoDocumento_Click" />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div id="gridHistorico">
            <asp:GridView ID="gvHistoricoAvances" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ValorSueldo" HeaderText="Valor Sueldo" /> 
                    <asp:BoundField DataField="ValorPrestaciones" HeaderText="Valor Prestaciones" /> 
