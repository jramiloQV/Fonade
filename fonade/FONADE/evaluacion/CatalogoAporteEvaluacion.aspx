<%@ Page Title="FONDO EMPRENDER" Language="C#" MasterPageFile="~/Emergente.Master" AutoEventWireup="true" CodeBehind="CatalogoAporteEvaluacion.aspx.cs" Inherits="Fonade.FONADE.evaluacion.CatalogoAporteEvaluacion" %>
   ...
   <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePageMethods="True">
    ...
    <table align="center" width="60%">
        ...
        <tr>
            ...
            <td class="style10">
                <asp:TextBox ID="txtsolicitado" runat="server" Width="158px" />
                <ajaxToolkit:FilteredTextBoxExtender ID="txtsolicitado_FilteredTextBoxExtender" runat="server"
                    Enabled="True" TargetControlID="txtsolicitado" ValidChars="1234567890" 
                    FilterType="Numbers">
        ...
        <tr>
            ...
            <td class="style10">
                <asp:TextBox ID="txtRecomendado" runat="server" Width="157px" >0</asp:TextBox>
