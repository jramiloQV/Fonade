...
namespace Fonade.FONADE.interventoria
{
    public partial class ImprimirInformeInterventoriaPresup : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            idInformePresupuestal = HttpContext.Current.Session["INF_idInformePresupuestal"] != null ? idInformePresupuestal = HttpContext.Current.Session["INF_idInformePresupuestal"].ToString() : "0";

            if (!IsPostBack)
            {
                if (idInformePresupuestal == "0")
                { idInformePresupuestal = HttpContext.Current.Session["idInformePresupuestal"] != null ? idInformePresupuestal = HttpContext.Current.Session["idInformePresupuestal"].ToString() : "0"; }
