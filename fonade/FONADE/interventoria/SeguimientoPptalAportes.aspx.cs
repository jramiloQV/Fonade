...
namespace Fonade.FONADE.interventoria
{
    public partial class SeguimientoPptalAportes : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(Negocio.PlanDeNegocioV2.Utilidad.ProyectoGeneral.VerificarVersionProyecto(Convert.ToInt32(CodProyecto), 2))
                Response.Redirect("~/PlanDeNegocioV2/Ejecucion/Seguimiento/AportesEjecucion.aspx?codproyecto="+ CodProyecto);
