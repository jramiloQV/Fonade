<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoNominaInter.aspx.cs" ValidateRequest="false"
                ...
                <asp:GridView ID="GrvDocumentos" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderStyle-Width="3%">
                            <ItemTemplate>
                                <asp:ImageButton ID="btn_Borrar" CommandName="Borrar" CommandArgument='<%# Eval("CodCargo")+";"+Eval("CodDocumentoFormato")+";"+ Eval("Mes")+";"+Eval("NomDocumento") %>'
                                    runat="server" ImageUrl="/Images/icoBorrar.gif" Visible="true"
                                    OnClientClick="return confirm('Esta seguro que desea borrar el documento seleccionado?, en caso de eliminarlo este no se podrá recuperar.')" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkNombre" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Mes") + ";" + Eval("NomDocumento") + ";" + Eval("CodCargo") %>' 
