<%@ Page Title="FONDO EMPRENDER" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="InterventorInforme.aspx.cs" Inherits="Fonade.FONADE.interventoria.InterventorInforme" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlace" runat="server">
     ...
     <table class="style10">
        <tr>
            <td>
            <h1>
                <asp:Label ID="lbltitulo" runat="server"  style="font-weight: 700">Informes De Interventoria</asp:Label>
                </h1>
            </td>
        </tr>
    </table>
