<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="UnidadesDeEmprendimiento.aspx.cs" Inherits="Fonade.FONADE.JefeUnidad.UnidadesDeEmprendimiento" %>
                            ...
                            <asp:GridView ID="gvUnidadesEmprendimiento" runat="server" Width="98%" AutoGenerateColumns="false" DataSourceID="dsUnidadEmprendimiento"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Nombre Unidad" ControlStyle-CssClass="miClase" SortExpression="NombreUnidad" HeaderStyle-Width="40%">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEditarUnidadEmprendimiento" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Id")%>' CommandName="update" Text='<%# Eval("NombreUnidad")+ " "  +"("+Eval("NombreInstitucion")+")" %>' />
                                        </ItemTemplate>
