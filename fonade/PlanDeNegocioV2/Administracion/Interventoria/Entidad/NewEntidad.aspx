<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="NewEntidad.aspx.cs" Inherits="Fonade.PlanDeNegocioV2.Administracion.Interventoria.Entidad.NewEntidad" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">        
        function alerta() {
            return confirm('¿ Esta seguro de crear esta entidad ?');
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlace" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">               
        <ContentTemplate>
            <h1>
                <asp:Label Text="Crear entidad" runat="server" ID="lblMainTitle" Visible="true" />
            </h1            
            <br />
            <table id="gvMain" class="auto-style2" runat="server">
                ...
                <tr>
                    <td class="auto-style3">
                        <asp:Label ID="Label13" runat="server" Font-Bold="true" Text="Operador"></asp:Label>
                         <br />                        
                          <asp:DropDownList ID="ddlOperador" runat="server" 
                              DataValueField="IdOperador" DataTextField="NombreOperador">  
                          </asp:DropDownList>     
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3" >
                        <asp:Label ID="Label10" Font-Bold="true" runat="server" Text="Logo - 100px * 100px"></asp:Label>
                        <br />                        
                 ...
                 <tr>
                    <td class="auto-style3" >
                        ...
                        <br />   
                        <br />   
                        <asp:GridView ID="gvDepartamentos" runat="server" AllowPaging="false"   AutoGenerateColumns="False" EmptyDataText="No hay datos que mostrar." Width="98%" BorderWidth="0" CellSpacing="1" CellPadding="4" CssClass="Grilla" HeaderStyle-HorizontalAlign="Left" ShowHeaderWhenEmpty="true" Visible="true" EnableViewState="true" DataSourceID="data" OnRowDataBound="gvProyectos_RowDataBound">
                                <Columns>   
                                    <asp:TemplateField HeaderText="#">
                                        <ItemTemplate>
                                            <asp:CheckBox runat="server" ID="chkDepartamento" />
                                        </ItemTemplate>
                                    </asp:TemplateField>         
                                    <asp:TemplateField HeaderText="Departamentos" >
                                        <ItemTemplate>
                                            <asp:Label Text='<%# Eval("NomDepartamento") %>' runat="server" Font-Bold="true" />
                                            <br />                                            
                                            <asp:HiddenField runat="server" ID="hdCodigoDepartamento" Value='<%# Eval("Id_departamento") %>' />                                                                                        
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <tr>
                    <td >
                        ...
                        <asp:Button ID="btnAdicionar" runat="server" Text="Guardar entidad" OnClientClick="return alerta();" OnClick="btnAdd_Click"></asp:Button>            
                    </td>
                </tr>               
            </table>
            <br />         
            ...
            <asp:ObjectDataSource
                    ID="data"
                    runat="server"
                    TypeName="Fonade.PlanDeNegocioV2.Administracion.Interventoria.Entidad.NewEntidad"
