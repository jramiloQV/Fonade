<%@ Page Title="" Language="C#" MasterPageFile="~/Emergente.Master" AutoEventWireup="true" CodeBehind="UnidadEmprendimiento.aspx.cs" Inherits="Fonade.PlanDeNegocioV2.Administracion.UnidadEmprendimiento.UnidadEmprendimiento" ValidateRequest="false" EnableEventValidation="false" %>
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
      <ContentTemplate>                                                  
         <div style="width:1000px;margin:0 auto;">
            <div class="form-horizontal no-margin center-block">
               <div class="form-group center-block">                  
                ...
                <div class="form-group center-block">
                  <label class="control-label col-xs-4"> Tipo de unidad : </label>
                  <div class="col-xs-4">                                         
               ...
               <div class="form-group center-block">
                  <label class="control-label col-xs-4"> Nombre de unidad : </label>
                  <div class="col-xs-4">
                     <asp:TextBox ID="txtNombreUnidad" runat="server" MaxLength="80" Width="400px" />
                  </div>
               </div>
               <div class="form-group center-block">
                  <label class="control-label col-xs-4"> Nombre de Centro o Institución : </label>
                  <div class="col-xs-4">
                     <asp:TextBox ID="txtNombreInstitucion" runat="server" MaxLength="80" Width="400px" />
                  </div>
               </div>
               <div class="form-group center-block">
                  <label class="control-label col-xs-4"> NIT Centro o Institución : </label>
                  <div class="col-xs-4">
                     <asp:TextBox ID="txtNitInstitucion" runat="server" MaxLength="80" Width="400px" />
                  </div>
               </div>
               <div class="form-group center-block">
               ...
               <div class="form-group center-block">
                ...
                <div class="form-group center-block">
                  ...
                  <div class="col-xs-4">
                     <asp:TextBox ID="txtSitioWeb" runat="server" MaxLength="100" Width="400px" />
                  </div>
               </div>
               <div class="form-group center-block">
                  <label class="control-label col-xs-4"> Teléfono: </label>
                  <div class="col-xs-4">
                     <asp:TextBox ID="txtTelefono" runat="server" MaxLength="100" Width="400px" />
                  </div>
               </div>
               <div class="form-group center-block">
                  <label class="control-label col-xs-4"> Dirección de Correpondencia: </label>
                  <div class="col-xs-4">
                     <asp:TextBox ID="txtDireccion" runat="server" MaxLength="100" Width="400px" />
                  </div>
               </div>
                <div class="form-group center-block">
               ...
               <div class="form-group center-block" >
                  ...
                  <div class="col-xs-4">
                     ...
                     <asp:Button ID="btnBuscarJefeUnidad" Text="Buscar" runat="server" BackColor="#6699FF" OnClick="btnBuscarJefeUnidad_Click" />                      
                      <br />
                      <asp:Button ID="btnCambiarDatos" Text="Cambiar Datos de jefe de unidad" runat="server" BackColor="#6699FF" Visible="false" OnClick="btnCambiarDatos_Click" /> 
                  </div>
               </div>
               <div id="divMotivoCambio" class="form-group center-block" runat="server" >
                  <label class="control-label col-xs-4"> Razón de adición o cambio de Jefe de Unidad : </label>
                  <div class="col-xs-4">
         ...
         <asp:ObjectDataSource ID="dsTipoUnidad" runat="server" EnablePaging="false" SelectMethod="getTipoUnidad"
            TypeName="Fonade.PlanDeNegocioV2.Administracion.UnidadEmprendimiento.UnidadEmprendimiento" >
            ...
            <div class="modal-body">
                       ...
                       <div id="nuevoJefeUnidad" runat="server" visible="false">
                           ...
                           <div class="form-group center-block">
                                <label class="control-label col-xs-4"> Ciudad: </label>
                                <div class="col-xs-4">
                                    <asp:DropDownList runat="server" ID="cmbCiudadJefe" nombre="Ciudad" DataSourceID="dsCiudadJefeUnidad" DataTextField="Nombre" DataValueField="Id" Width="200px" />
                                </div>
                            </div>                                                                                    
                            <div class="form-group center-block">
                           ...
                           <div class="form-group center-block">                                
                                <div class="col-xs-8">
                                  ...
                                  <asp:Button ID="btnActualizarJefeUnidad" runat="server" Text="Actualizar jefe de unidad" Visible="false"  OnClick="btnActualizarJefeUnidad_Click" />
                       ...
                       <div id="listadoUsuarios" runat="server" visible="true">
                           <asp:GridView ID="gvUsuarios" runat="server" AutoGenerateColumns="false" CssClass="Grilla" HeaderStyle-HorizontalAlign="Left" RowStyle-HorizontalAlign="Left" Width="100%" PageSize="10" AllowPaging="true" DataSourceID="dsBusquedaJefe" EmptyDataText="Ningun registro para mostrar." OnRowCommand="gvUsuarios_RowCommand" >
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Unidad actual">
                                            <ItemTemplate>
                                                <asp:Label ID="lblInstitucion" Text='<%# Eval("InstitucionActual")%>' runat="server" CausesValidation="false" />                                                
                                            </ItemTemplate>
                                        </asp:TemplateField>                                                                                                                       
                                        <asp:TemplateField HeaderText="Estado contacto">
                                            <ItemTemplate>
                                                <asp:Label ID="lblEstadoContacto" Text='<%# Eval("EstadoJefe")%>' runat="server" CausesValidation="false" />                                                
                                            </ItemTemplate>
                                        </asp:TemplateField>
