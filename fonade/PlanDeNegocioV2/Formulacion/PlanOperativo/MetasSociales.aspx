<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MetasSociales.aspx.cs" Inherits="Fonade.PlanDeNegocioV2.Formulacion.PlanOperativo.MetasSociales" %>
    ...
    <form id="form1" runat="server" style="background-color: white; background-image: none">
        ...
        <asp:Panel ID="pnlPrincipal" Visible="true" runat="server">
            ...
            <div style="position: relative; left: 720px; width: 160px;">
                <controlPostit:Post_It runat="server" ID="Post_It" Visible='<%# PostitVisible %>' _txtCampo="MetasSociales" />
            </div>
            <br />
