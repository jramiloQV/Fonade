...
{
    public partial class CostosAdministrativos : Negocio.Base_Page
    {
        ...
        public int txtTab = Constantes.CONST_CostosAdministrativosV2;
        ...
        void SetPostIt()
        {
            ...
            Post_It._txtTab = Constantes.CONST_CostosAdministrativosV2;
        }
        ...
        protected void btnAdicionarGasto_Click(object sender, EventArgs e)
        {
            ...
            CatalogoGasto1.Cargar(CatalogoGastoV2.Accion.Nuevo, CodigoProyecto.ToString(), "0", "Arranque");
        }
        ...
        protected void btnAdicionarGastoAnual_Click(object sender, EventArgs e)
        {
            pnlPrincipal.Visible = false;
            pnlGastos.Visible = true;
            CatalogoGasto1.Cargar(CatalogoGastoV2.Accion.Nuevo, CodigoProyecto.ToString(), "0", "Anual");
        }
        ...
        protected void gw_GastosPersonal_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "BorrarPersonal")
            {
                ...
                string respuesta = CatalogoCargo1.Cargar(CatalogoCargo.Accion.Borrar, CodigoProyecto.ToString(), idCargo);
                if (respuesta == "OK")
                {
            ...
            if (e.CommandName == "EditarPersonal")
            {
                ...
                pnlCargo.Visible = true;
                string idCargo = e.CommandArgument.ToString();
                CatalogoCargo1.Cargar(CatalogoCargo.Accion.Editar, CodigoProyecto.ToString(), idCargo);
            }
        ...
        protected void gw_GastosPuestaMarca_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "BorrarMarcha")
            {
                ...
                string respuesta = CatalogoGasto1.Cargar(CatalogoGastoV2.Accion.Borrar, CodigoProyecto.ToString(), idGasto, "Arranque");
                if (respuesta == "OK")
                {
                    //CargarGastosPuestaMarca();
                }
            ...
            if (e.CommandName == "EditarMarcha")
            {
                ...
                pnlGastos.Visible = true;
                string idGasto = e.CommandArgument.ToString();
                CatalogoGasto1.Cargar(CatalogoGastoV2.Accion.Editar, CodigoProyecto.ToString(), idGasto, "Arranque");
            }
