...
{
    public partial class PlanDeCompras : Negocio.Base_Page
    {
        ...
        public int txtTab = Constantes.CONST_PlanDeComprasV2;
        ...
        void SetPostIt()
        {
            ...
            Post_It._txtTab = Constantes.CONST_PlanDeComprasV2;
        }
        ...
        protected void lnkBtn_AddInsumo_Click(object sender, EventArgs e)
        {
            if (sender is ImageButton)
            {
                ...
                if (lnkBtn.CommandName.Equals("Lista"))
                {
                    ...
                    Response.Redirect("Intermedia.aspx?codproducto=" + lnkBtn.CommandArgument + "&codproyecto=" + CodigoProyecto);
                }
            }
        ...
        private void ObtenerDatosUltimaActualizacion()
        {
            ...
            try
            {
                ...
                numPostIt = opRoleNeg.Obtener_numPostIt(Convert.ToInt32(CodigoProyecto), Convert.ToInt32(usuario.IdContacto));
                ...
                var avk = opRoleNeg.ObtenerRolUsuario(CodigoProyecto.ToString(), usuario.IdContacto) ?? string.Empty;
                ...
                if (!(EsMiembro && numPostIt == 0 && ((codRole == Constantes.CONST_RolAsesorLider.ToString() && CodigoEstado == Constantes.CONST_Inscripcion) || (CodigoEstado == Constantes.CONST_Evaluacion && codRole == Constantes.CONST_RolEvaluador.ToString() && es_bNuevo(CodigoProyecto.ToString())))) || lbl_nombre_user_ult_act.Text.Trim() == "")
                ...
                if (EsMiembro && numPostIt == 0 && lbl_nombre_user_ult_act.Text != "" && (codRole == Constantes.CONST_RolAsesorLider.ToString() && CodigoEstado == Constantes.CONST_Inscripcion) || (codRole == Constantes.CONST_RolEvaluador.ToString() && CodigoEstado == Constantes.CONST_Evaluacion && es_bNuevo(CodigoProyecto.ToString())))
                {
