...
{
    public partial class Ingresos : Negocio.Base_Page
    {
        ...
        public int txtTab = Constantes.CONST_IngresosV2;
        ...
        public bool vldt { get { if (usuario.CodGrupo == Constantes.CONST_Evaluador) { return false; } else { return new Clases.genericQueries().ValidateUserCode(usuario.IdContacto, CodigoProyecto.ToString()); } } }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (usuario.CodGrupo == Constantes.CONST_Emprendedor)
                {
                    if (File.Exists(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + @"Proyecto\" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + @"\Proyecto_" + CodigoProyecto + @"\FORMATOSFINANCIEROS" + CodigoProyecto + ".xls"))
                    {
                        btnLinkVerModeloFinanciero.Visible = true;
                ...
                if (usuario.CodGrupo == Constantes.CONST_Evaluador 
                    ...
                    || usuario.CodGrupo == Constantes.CONST_PerfilAcreditador)
                {                    
                    if (File.Exists(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + @"Proyecto\" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + @"\Proyecto_" + CodigoProyecto + @"\FORMATOSFINANCIEROS" + CodigoProyecto + ".xls"))
                    {
                        btnLinkVerModeloFinanciero.Visible = true;
                    ...
                    && !bRealizado)
                {
                    ...
                    bntModeloFinancieroComercial.Visible = false;
                    bntModeloFinancieroIndustrial.Visible = false;
                    bntModeloFinancieroAgropecuario.Visible = false;
            ...
            string ruta = ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + @"Proyecto\" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + @"\Proyecto_" + CodigoProyecto + @"\";
            if (File.Exists(ruta + "FORMATOSFINANCIEROS.xls") || File.Exists(ruta + "FORMATOSFINANCIEROS" + CodigoProyecto + ".xls") || File.Exists(ruta + "FORMATOSFINANCIEROS.xlsx") || File.Exists(ruta + "FORMATOSFINANCIEROS" + CodigoProyecto + ".xlsx"))
            {
        ...
        void SetPostIt()
        {
            ...
            Post_It._txtTab = Constantes.CONST_IngresosV2;
        }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            var query = (from p in consultas.Db.ProyectoFinanzasIngresos where p.CodProyecto == Convert.ToInt32(CodigoProyecto) select new { p.CodProyecto }).ToList();
        ...
        {
            var query = (from p in consultas.Db.ProyectoFinanzasIngresos where p.CodProyecto == Convert.ToInt32(CodigoProyecto) select p).First();
        ...
        private void CargarControlesEditarAporte()
        {
            ...
            var query = (from p in consultas.Db.ProyectoAportes where p.CodProyecto == Convert.ToInt32(CodigoProyecto) && p.Id_Aporte == Convert.ToInt32(idAporteEdita) select p).First();
        ...
        {
            var query = (from p in consultas.Db.ProyectoRecursos where p.CodProyecto == Convert.ToInt32(this.CodigoProyecto) orderby p.Tipo ascending select new { p.Id_Recurso, p.Tipo, p.Cuantia, p.Plazo, p.Formapago, p.Interes, p.Destinacion });
        ...
        private void CargarControlesEditarRecurso()
        {
            ...
            var query = (from p in consultas.Db.ProyectoRecursos where p.CodProyecto == Convert.ToInt32(CodigoProyecto) && p.Id_Recurso == Convert.ToInt32(idRecursoEdita) select p).First();
        ...
        protected void btnLinkSubirModeloFinanciero_Click(object sender, EventArgs e)
        {
            ...
            string ruta = ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + @"Proyecto\" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + @"\Proyecto_" + CodigoProyecto + @"\";
            //string ruta = ConfigurationManager.AppSettings.Get("RutaDocumentos") + @"Proyecto\" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + @"\Proyecto_" + CodigoProyecto + @"\";
            string archivo = @"\FORMATOSFINANCIEROS" + CodigoProyecto;
        ...
        protected void btnLinkVerModeloFinanciero_Click(object sender, EventArgs e)
        {
            ...
            string ruta = ConfigurationManager.AppSettings.Get("RutaWebSite") + ConfigurationManager.AppSettings.Get("DirVirtual2") + @"Proyecto/" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + @"\Proyecto_" + CodigoProyecto + @"\FORMATOSFINANCIEROS" + CodigoProyecto + ".xls";

            if (File.Exists(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + @"Proyecto\" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + @"\Proyecto_" + CodigoProyecto + @"\FORMATOSFINANCIEROS" + CodigoProyecto + ".xls"))
            {
                DescargarArchivo(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + @"Proyecto\" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + @"\Proyecto_" + CodigoProyecto + @"\FORMATOSFINANCIEROS" + CodigoProyecto + ".xls");
            }
            else
            {
        ...
        void SubirArchivo_Click(object sender, CommandEventArgs e)
        {
            ...
            string rutaHttpDestino = "Documentos/Proyecto/" + Math.Abs(Convert.ToInt32(CodigoProyecto) / 2000) + "/" + "Proyecto_" + CodigoProyecto + "/" + "FORMATOSFINANCIEROS" + CodigoProyecto + ".xls";

            RespuestaCargue respuesta = CargarArchivos1.Resultado();
            if (respuesta.Mensaje == "OK")
            {
                var query = (from d in consultas.Db.Documentos where d.CodTab == txtTab && d.CodProyecto == Convert.ToInt32(CodigoProyecto) && d.NomDocumento.Contains("Formato Financieros") select d);
        ...
        private void ObtenerDatosUltimaActualizacion()
        {
            ...
            try
            {
                ...
                CodigoEstado = CodEstado_Proyecto(txtTab.ToString(), CodigoProyecto.ToString(), "");
        ...
        protected void bntModeloFinancieroComercial_Click(object sender, EventArgs e)
        {
            ClientScriptManager cm = this.ClientScript;

            if (System.IO.Directory.Exists(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + ConfigurationManager.AppSettings.Get("ModeloFinanciero") + "Emprendedor"))
            {
                DescargarArchivo(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + ConfigurationManager.AppSettings.Get("ModeloFinanciero") + @"Emprendedor\MFIN_Comercial_y_Servicios.xls");
            }
            else
            {
                cm.RegisterClientScriptBlock(this.GetType(), "", "<script type='text/javascript'>alert('La ruta relacionada no existe.');</script>");
        ...
        protected void bntModeloFinancieroIndustrial_Click(object sender, EventArgs e)
        {
            ClientScriptManager cm = this.ClientScript;

            if (System.IO.Directory.Exists(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + ConfigurationManager.AppSettings.Get("ModeloFinanciero") + "Emprendedor"))
            {
                DescargarArchivo(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + ConfigurationManager.AppSettings.Get("ModeloFinanciero") + @"Emprendedor\MFIN_Industrial.xls");
            }
            else
            {
                cm.RegisterClientScriptBlock(this.GetType(), "", "<script type='text/javascript'>alert('La ruta relacionada no existe.');</script>");
        ...
        protected void bntModeloFinancieroAgropecuario_Click(object sender, EventArgs e)
        {
            ClientScriptManager cm = this.ClientScript;

            if (System.IO.Directory.Exists(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + ConfigurationManager.AppSettings.Get("ModeloFinanciero") + "Emprendedor"))
            {
                DescargarArchivo(ConfigurationManager.AppSettings.Get("RutaIP") + ConfigurationManager.AppSettings.Get("DirVirtual") + ConfigurationManager.AppSettings.Get("ModeloFinanciero") + @"Emprendedor\MFIN_Agropecuario.xls");
            }
            else
            {
                cm.RegisterClientScriptBlock(this.GetType(), "", "<script type='text/javascript'>alert('La ruta relacionada no existe.');</script>");
