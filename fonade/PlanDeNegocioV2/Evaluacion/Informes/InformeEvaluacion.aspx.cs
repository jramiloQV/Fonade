...

{
    public partial class InformeEvaluacion : Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                CodProyecto = Request.QueryString["IdProyecto"];
                if (CodProyecto == "0")
                {
                    CodProyecto = Session["CodProyecto"].ToString();
                }

                CodConvocatoria = Negocio.PlanDeNegocioV2.Utilidad.Convocatoria.GetConvocatoriaByProyecto(int.Parse(CodProyecto), HttpContext.Current.Session["HistorialEvaluacion"] != null ? Convert.ToInt32(HttpContext.Current.Session["HistorialEvaluacion"]) : 0).GetValueOrDefault().ToString();
        ...
        private DataTable ObservacionEvaluacion()
        {
            try
            {
                ...
                if (rs.Rows.Count > 0)
                {
                    ...
                    txtGenerales = rs.Rows[0]["ResumenConcepto"].ToString(); //Resumen Concepto
                    txtLocalizacion = rs.Rows[0]["Localizacion"].ToString(); //Localizacion
                    txtSector = rs.Rows[0]["Sector"].ToString(); //Sector
        ...
        private void GenerarTerceraTabla()
        {
            ...
            try
            {
                ...
                lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "</tr>";//"<td class='TituloTabla' align='center'><span style='color:#ffffff'>Promedio<br>sector</span></td>" +
        ...
        private void GenerarSeptimaTabla()
        {
            ...
            try
            {
                ...
                lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "<table style='font-size: 10px' width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000'>" +
                                                                      "	<tr><td colspan='7'>" +
                                                                      "		<table style='font-size: 10px' width='100%' border='0' cellpadding='3' cellspacing='1'>" +
                                                                      "			<tr><td bgcolor='#000000' class='TituloTabla' height='30'><span style='color:#ffffff'>Localización</span></td></tr>" +
                                                                      "			<tr><td height='30'>" + txtLocalizacion + "</td></tr>" +
                                                                      "		</table>" +
                                                                      "	</td></tr>		" +
                                                                      "</table>			" +
                                                                      "<br/>";
                ...
                lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "<table style='font-size: 10px' width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000'>" +
                                                                      "	<tr><td colspan='7'>" +
                                                                      "		<table style='font-size: 10px' width='100%' border='0' cellpadding='3' cellspacing='1'>" +
                                                                      "			<tr><td bgcolor='#000000' class='TituloTabla' height='30'><span style='color:#ffffff'>Sector</span></td></tr>" +
                                                                      "			<tr><td height='30'>" + txtSector + "</td></tr>" +
                                                                      "		</table>" +
                                                                      "	</td></tr>		" +
                                                                      "</table>			" +
                                                                      "<br/>";
        ...
        private void GenerarOctavaTabla()
        {
            ...
            try
            {
                ...
                txtSQL = " SELECT id_campo, Campo, Puntaje, TipoCampo " +
                ...
                for (int i = 0; i < rsAux.Rows.Count; i++)
                {
                    ...
                    txtSQL = " SELECT C.TipoCampo, C.id_campo, c.campo, p.id_campo as idVariable, case when cc.Puntaje is null then c.campo else p.campo end orden, cc.Puntaje Maximo, isnull(ec.Puntaje, 0) Asignado " +
                             " FROM CAMPO C " +
                    ...
                    for (int j = 0; j < rs.Rows.Count; j++)
                    {
                        ...
                        if (rsAux.Rows[i]["Campo"].ToString() != "Medio Ambiente")
                        {
                            ...
                            lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                                "<td align='center'>" + ValueSiNo(rs.Rows[j]["TipoCampo"].ToString(), rs.Rows[j]["Asignado"].ToString()) + "</td>" +
                                "<td align='center'>" + ValueSiNo(rs.Rows[j]["TipoCampo"].ToString(), rs.Rows[j]["Maximo"].ToString()) + "</td>";
                        }
                        else
                        {
                    ...
                    //Generar nueva fila.
                    lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                        "<td class='Titulo' align='right' colspan='2' >Puntaje:</td>";
                    if (rsAux.Rows[i]["Campo"].ToString() != "Medio Ambiente")
                    {
                        lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                            "<td class='Titulo' align='center'>" + (rsAux.Rows[i]["TipoCampo"].ToString().Equals("1") ? (numTotal.Equals(3) ? "SI" : (numTotal < 3 ? "NO" : numTotal.ToString())) : numTotal.ToString()) + "</td>" +
                                "<td>&nbsp;</td>";
                    }
                    else
                    {
                    ...
                    if (rsAux.Rows[i]["Campo"].ToString() != "Resumen ejecutivo")
                    {
                        lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                            "<td align='center'>" + ValueSiNo(rsAux.Rows[i]["TipoCampo"].ToString(), rsAux.Rows[i]["Puntaje"].ToString()) + "</td>" +
                                "<td>&nbsp;</td>";
                    }
                    else
                    {
        ...
        string ValueSiNo(string tipoCampo, string value)
        {
            if (tipoCampo.Equals("1"))
                return value.Equals("1") ? "SI" : value.Equals("0") ? "NO" : value;
            else
                return value;
        }
        ...
        private void GenerarNovenaTabla()
        {
            ...
            try
            {
                ...
                //[31/07/2018] Antes X.TipoCampo por CA.TipoCampo y no estaba , P.tipoCampo en la subconsulta X
                txtSQL = "SELECT        X.idAspecto, X.Campo, D.Puntaje AS Minimo, ISNULL(SUM(EC.Puntaje), 0) AS Total, X.TipoCampo" +
                        " FROM ConvocatoriaCampo AS CC INNER JOIN" +
                        " (SELECT        P.Campo, P.id_Campo AS idAspecto, V.id_Campo AS idVariable, C.id_Campo AS idCampo, P.tipoCampo" +
                        " FROM            Campo AS P LEFT OUTER JOIN" +
                        " Campo AS V ON P.id_Campo = V.codCampo LEFT OUTER JOIN" +
                        " Campo AS C ON V.id_Campo = C.codCampo" +
                        " WHERE(C.id_Campo IS NOT NULL) AND(V.id_Campo IS NOT NULL)) AS X ON CC.codCampo = X.idCampo AND CC.codConvocatoria = " + CodConvocatoria + " INNER JOIN" +
                        " ConvocatoriaCampo AS D ON X.idAspecto = D.codCampo AND CC.codConvocatoria = D.codConvocatoria INNER JOIN" +
                        " Campo AS CA ON X.idCampo = CA.id_Campo LEFT OUTER JOIN" +
                        " EvaluacionCampo AS EC ON CC.codConvocatoria = EC.codConvocatoria AND EC.codProyecto = " + CodProyecto + " AND X.idCampo = EC.codCampo" +
                        " GROUP BY X.idAspecto, X.Campo, D.Puntaje, X.TipoCampo" +
                ...
                {
                    int tipoCampo = (int)row_rsAux["TipoCampo"];
                    ...
                    {
                        string total = row_rsAux["Total"].ToString();

                        lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                            "<td align='center'>" + (tipoCampo == 1 ? total.Equals("3") ? "SI" : "NO" : total) + " </ td > " +
                                "<td align='center'>" + ValueSiNo(row_rsAux["TipoCampo"].ToString(), row_rsAux["Minimo"].ToString()) + "</td>";
                    }
                    else
                    {
                        //Total.
        ...
        string GetTipoAporte(string tipoAporte, string value)
        {
        ...
        private void GenerarDuodecimaTabla()
        {
            ...
            try
            {
                ...
                foreach (DataRow row_RS in RS.Rows)
                {
                                    ...
                                    "<tr><td width='0%'></td>" +
                                                ...
                                                "<tr><td colspan='3'>" +
                                                    "<table style='font-size: 10px' width='100%' border='0' cellpadding='4' cellspacing='1' class='zebra'>			" +
                                                        ...
                                                        "	<td bgcolor='#000000' width='16%' class='tituloTabla'><span style='color:#ffffff'>Nombre</span></td>" +
                                                        "	<td bgcolor='#000000' width='28%' class='tituloTabla'><span style='color:#ffffff'>Detalle</span></td>" +
                                                        "	<td bgcolor='#000000' width='16%' class='tituloTabla'><span style='color:#ffffff'>Fuente de Financiación</span></td>" +
                                                        ...
                                                        "	<td bgcolor='#000000' width='15%' class='tituloTabla' align='center'><span style='color:#ffffff'>Total Recomendado</span></td>" +
                                                        "	<td bgcolor='#000000' width='5%' class='tituloTabla' align='center'><span style='color:#ffffff'>%</span></td>" +
                                                        "</tr>";
                    #endregion
                    ...
                    txtSQL = "SELECT E.Id_Aporte, E.Nombre, E.Detalle, FF.DescFuente, E.Solicitado, ISNULL(E.Recomendado, 0) AS recomendado, E.Protegido" +
                            " FROM EvaluacionProyectoAporte AS E LEFT OUTER JOIN" +
                            " FuenteFinanciacion AS FF ON E.IdFuenteFinanciacion = FF.IdFuente" +
                            " WHERE(E.CodProyecto = " + CodProyecto + ") AND(E.CodConvocatoria = " + CodConvocatoria + ") AND(E.CodTipoIndicador = " + row_RS["id_TipoIndicador"].ToString() + ")" +
                            " ORDER BY E.Id_Aporte";
                    ...
                    foreach (DataRow row_rsAux in rsAux.Rows)
                    {
                        ...
                        lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                            "</td>" +
                            "	<td style='text - align: left'>" + row_rsAux["Nombre"].ToString() + "</td>" +
                            "	<td style='text - align: left'>" + row_rsAux["Detalle"].ToString() + "</td>" +
                              "	<td style='text - align: left'>" + GetTipoAporte(row_rsAux["Detalle"].ToString(), row_rsAux["DescFuente"].ToString()) + "</td>" +
                ...
                lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                    ...
                    "<tr><td style='width:25%'></td><td style='width:50%; text-align: left;'>Recursos solicitados al fondo emprender en (smlv)</td>" +
                    "<td style='width:25%'><input readonly value='" + txtSolicitado + "' style='text-align:right'/></td></tr>" +
                    "<tr><td style='width:25%'></td><td style='width:50%; text-align: left;'>Valor recomendado (smlv)</td>" +
                    "<td style='width:25%'><input readonly value='" + txtRecomendado + "' style='text-align:right'/></td></tr>" +
                    "</table>" +
                    "		</TD>" +
                    "	</TR>		" +
                    "</table>";
