<%@ Page Title="" Language="C#" MasterPageFile="~/PlanDeNegocioV2/Evaluacion/Master/EvaluacionSite.Master" AutoEventWireup="true" CodeBehind="Nomina.aspx.cs" Inherits="Fonade.PlanDeNegocioV2.Evaluacion.PlanOperativo.Nomina" %>
            ...
            <tr>
                ...
                <td>
                    <div id="div_Post_It1" runat="server" Visible="false">
                        <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="Nomina" _txtTab="1" _mostrarPost="false" />
                    </div>
                </td>
            </tr>
        </table>
